...
user = User.create_with(password: "useruser", password_confirmation: "useruser", name: "Nacho Abad", time_zone: "Eastern Time (US & Canada)").find_or_create_by! email: "user@mail.com"
